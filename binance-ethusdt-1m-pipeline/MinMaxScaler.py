...
# === 确认 ts 列是 datetime 并设为索引 ===
# Ensure 'ts' is datetime type and set as index
...
df["MACD"] = macd.macd()                 # MACD 主线 / main line
...
# === 保存前500行到 CSV / Save first 500 rows to CSV ===
